...
class LlamaModel:
    def __init__(self, model_name="llama3.1"):
        ...
        self.client = ollama
        # self.ratatouille_client = ratatouille.Client()
    ...
    def _create_prompt(self, conversation_chunk: str) -> str:
        """Create analysis prompt with Ratatouille context."""
        ratatouille_analysis = self._get_ratatouille_analysis(conversation_chunk)
    ...
    def _get_ratatouille_analysis(self, conversation_chunk: str) -> str:
        """Get Ratatouille analysis of the conversation chunk."""
        try:
            ratatouille_model = ratatouille.load_model()
            analysis = ratatouille_model.analyze(conversation_chunk)
            return f"Entities: {analysis.entities}\nSentiments: {analysis.sentiments}"
        except Exception as e:
            logging.error(f"Error getting Ratatouille analysis: {e}")
            return ""
